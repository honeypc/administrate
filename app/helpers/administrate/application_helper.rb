module Administrate
  module ApplicationHelper
    ...
    def administrate_importmap_tags(entry_point = "application", shim: true)
      safe_join [
        javascript_inline_importmap_tag(Administrate.configuration.importmap.to_json(resolver: self)),
        javascript_importmap_module_preload_tags(Administrate.configuration.importmap),
